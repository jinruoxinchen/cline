...
/**
 * Combines API request start and finish messages in an array of OneUnlimitedMessages.
 *
 ...
 * @returns A new array of OneUnlimitedMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: OneUnlimitedMessage[]): OneUnlimitedMessage[] {
	const combinedApiRequests: OneUnlimitedMessage[] = []
