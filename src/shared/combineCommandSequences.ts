import { OneUnlimitedMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of OneUnlimitedMessages.
 *
 * This function processes an array of OneUnlimitedMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of OneUnlimitedMessage objects to process.
 * @returns A new array of OneUnlimitedMessage objects with command sequences combined.
 *
 * @example
 * const messages: OneUnlimitedMessage[] = [
 ...
 */
export function combineCommandSequences(messages: OneUnlimitedMessage[]): OneUnlimitedMessage[] {
	const combinedCommands: OneUnlimitedMessage[] = []
