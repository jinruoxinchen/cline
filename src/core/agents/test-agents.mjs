...
import { TeamLeaderAgent } from "../agents/TeamLeaderAgent.js"
import { FullStackDeveloperAgent } from "../agents/FullStackDeveloperAgent.js"
import * as MessageBus from "../comm/MessageBus.js"
...
async function testAgentArchitecture() {
	...
	// Create a sinon stub for the message bus
	const messageStub = sinon.stub(MessageBus, "postMessageToChannel").callsFake((params) => {
