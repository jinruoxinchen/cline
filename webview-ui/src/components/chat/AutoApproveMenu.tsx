			...
			{isExpanded && (
				<div style={{ padding: "0" }}>
					<div
						...
						Auto-approve allows OneUnlimited to perform the following actions without asking for permission. Please
					...
					<div
						...
						OneUnlimited will automatically make this many API requests before asking for approval to proceed with the
						task.
					</div>
					<div style={{ margin: "6px 0" }}>
						...
						<div
							...
							Receive system notifications when OneUnlimited requires approval to proceed or when a task is
							completed.
						</div>
					</div>
				</div>
