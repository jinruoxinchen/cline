			...
			<div>
				...
				<ControlsContainer>
					...
					<Tooltip
						...
						tipText={`In ${shownTooltipMode === "act" ? "Act" : "Plan"}  mode, OneUnlimited will ${shownTooltipMode === "act" ? "complete the task immediately" : "gather information to architect a plan"}`}
